...
var FaqContent = React.createClass({
	...
	componentDidMount(){
		...
		configureAnchors({offset:-160, scrollDuration: 300});
	},
	scrollTop(){
		goToAnchor('service', true)
	...
	render(){
		return(
			<div className="faq-inner-wrap" style={this.props.navScroll === "shrink" ? {top: "210px", paddingBottom: "210px"}: {}}>
				<a className={this.state.scrollTop} onClick={this.scrollTop}></a>
				<ScrollableAnchor id="service">
					<section className="faq-section section-1">
						<div className="inner">
				...
				<ScrollableAnchor id="policy">
					<section className="faq-section section-2">
						<div className="inner">
							<h2>Policy Stuff</h2>
				...
				<ScrollableAnchor id="claims">
					<section className="faq-section section-3">
						<div className="inner">
							<h2>Claims</h2>
